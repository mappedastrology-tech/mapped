export interface BirdOracleCard {
  ...
  image: string;        // path "/oracle/bird/{number}.png"
  media?: {
    book?: string;
    film?: string;
    song?: string;
...
export const BIRD_ORACLE: BirdOracleDeckInfo = {
  ...
  cardCount: 72,
  coverImage: "/oracle/bird/1.png",
  backImage: "/oracle/bird/cardback.png",
  cards: [
    {
      id: "bird-1",
      number: 1,
