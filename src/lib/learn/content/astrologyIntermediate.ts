      ...
      lessons: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { kind: "callout", tone: "history", title: "An ancient scheme", text: "The system of essential dignities is laid out in texts like Ptolemy's 'Tetrabiblos' (2nd century CE) and was central to medieval and Renaissance astrology, which also used finer dignities (triplicity, terms, and faces) to score a planet's strength. Modern astrology often keeps domicile and exaltation while reading detriment and fall as a different mode of expression rather than a defect." },
      ...
      lessons: [
        ...
        },
        {
          ...
          blocks: [
            ...
            { kind: "callout", tone: "tip", title: "Concentrated focus", text: "A stellium concentrates energy intensely — a place of real talent and drive that needs conscious balance so one theme doesn't eclipse the rest of the chart. Whatever sign or house holds the stellium usually becomes a defining storyline of the life." },
